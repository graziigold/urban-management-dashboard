            ...
            <div className="relative">
              ...
              {marker.status === 'critical' && (
                <>
                  ...
                  <span className="absolute inset-0 rounded-full bg-red-400 opacity-30 animate-pulse scale-125" />
                </>
              )}
              ...
              <div className={`relative ${statusColors[marker.status]} rounded-full p-3.5 shadow-2xl transition-all duration-200 group-hover:scale-125 group-hover:shadow-3xl border-4 border-white/90 backdrop-blur-sm`}>
